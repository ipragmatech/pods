 ...
 */
const $ = jQuery;
export const PickFlexibleItem = Mn.LayoutView.extend( {
	tagName: 'li',
	...
	template: _.template( $( '#pick-flexible-item-template' ).html() ),
 ...
 */
export const PickFlexibleList = Mn.CollectionView.extend( {
	tagName: 'ul',

	className: 'pods-files pods-files-list',

	childView: PickFlexibleItem,
