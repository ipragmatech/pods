<script type="text/template" id="pick-flexible-layout-template">
	<div class="pods-ui-file-list"></div>
	<div class="pods-ui-region"></div>
	<div class="pods-ui-form"></div>
</script>

<script type="text/template" id="pick-flexible-item-template">
	<input
...
<script type="text/template" id="pick-flexible-form-template">
	<a class="button pods-file-add pods-media-add" href="#" tabindex="2"><%= options.file_add_button %></a>
</script>

<script type="text/template" id="pick-flexible-queue-template">
	<ul class="pods-file-meta media-item">
		<% if ( '' === error_msg ) { %>
